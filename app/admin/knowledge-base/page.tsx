      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        {loading ? (
          <div className="p-12 flex flex-col items-center justify-center space-y-3">
            ...
            <span className="text-xs font-bold text-gray-400">Loading Knowledge Base articles...</span>
          </div>
              ...
              <tbody className="divide-y divide-gray-100 text-gray-700">
                {filteredArticles.map((article) => (
                  <tr key={article.id} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4 font-bold text-gray-800 max-w-[160px] truncate" title={article.title}>
                      {article.title}
                    </td>
                    <td className="px-6 py-4 text-gray-500 max-w-[280px] truncate" title={article.content}>
                      {article.content}
                    </td>
                    <td className="px-6 py-4 text-center">
                      <span className="inline-flex items-center space-x-1 bg-violet-50 text-violet-600 border border-violet-100 px-2 py-0.5 rounded-md text-[9px] font-black uppercase">
      ...
      {isDeleteOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-950/40 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white border border-gray-100 shadow-2xl rounded-3xl w-full max-w-sm p-6 relative animate-in zoom-in-95 duration-200 mx-4">
            ...
            <h3 className="text-base font-black text-gray-900 mb-3">Delete Article?</h3>
